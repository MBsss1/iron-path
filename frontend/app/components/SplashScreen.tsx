  ...
  return (
    ...
    >
      <div className="text-center iron-shell-card py-10 px-12 animate-splash-logo border border-iron-border-strong">
        <h1 className="iron-heading text-4xl tracking-wide">Iron Path</h1>
        <p className="iron-page-header-sub mt-3">Est. 1950</p>
        <div className="mt-6 h-0.5 w-24 mx-auto bg-iron-accent-dim" />
        <p className="mt-4 text-xs text-iron-muted">Loading your journal…</p>
      </div>
    </div>
  );
}
