const en = {
  ...
  coaching: {
    ...
    milestones: {
      subtitle: "Physical stages — workouts adapt when you hit each target.",
      needAssessment: "Complete the fitness assessment to see your physical progress.",
      currentStage: "Stage {{from}} → {{to}}",
      nextTarget: "Next: {{current}} / {{target}} {{unit}}",
  ...
  assessment: {
    intro: {
      ...
      checkTitle: "We will check:",
      checkPull: "Pulling strength",
      checkPush: "Pushing strength",
      checkLegs: "Legs",
      checkCore: "Core",
      checkCardio: "Running and endurance",
      outro: "After that we will build your personal training plan.",
    ...
    pullups: {
      ...
      explain: "One set, dead hang, chin over the bar — no kipping.",
      tip: "Stop when form breaks; zero is a valid score.",
      warn: "Shoulder pain — stop and enter 0; note shoulders on the last step.",
      placeholder: "Reps",
    },
    pushups: {
      title: "Push-ups in 2 minutes",
      explain: "Full reps from the floor at a steady pace for 2:00.",
      tip: "Straight body line; full lockout at the top.",
      warn: "Not a one-set max — count only reps in 2 minutes.",
      placeholder: "Reps in 2 min",
    },
    squats: {
      title: "Squats in 2 minutes",
      explain: "Bodyweight squats, thighs at least parallel, for 2:00.",
      tip: "Weight through the whole foot; knees track over toes.",
      warn: "Stop if knees or lower back protest — enter what you did safely.",
      placeholder: "Reps in 2 min",
    },
    plank: {
      title: "Plank hold",
      explain: "Forearm or straight-arm plank — stop when hips sag.",
      tip: "Breathe steadily; neutral neck.",
